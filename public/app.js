...
$('generate').onclick = async () => {
  ...
  try {
    ...
    $('result').hidden = false; $('result').innerHTML = `生成完成。<a href="${appUrl(`/api/outputs/${result.output.id}/download`)}">下载 ${escapeHtml(result.output.name)} ↗</a>`; toast(`${records.length} 条记录已生成`, 'success');
