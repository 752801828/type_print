...
document.addEventListener('click', event => { if ($('settingsPanel').classList.contains('open') && !$('settingsPanel').contains(event.target) && !event.target.closest('[data-settings-id]')) closeTemplateSettings(); });
