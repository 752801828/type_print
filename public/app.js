...
const text = value => Array.isArray(value) ? value.map(text).filter(Boolean).join('、') : value && typeof value === 'object' ? (Object.hasOwn(value, 'text') ? String(value.text ?? '') : Object.hasOwn(value, 'name') ? String(value.name ?? '') : Object.hasOwn(value, 'value') ? text(value.value) : JSON.stringify(value)) : value == null ? '' : String(value);
