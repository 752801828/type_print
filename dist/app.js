...
$('menuToggle').onclick = () => { $('appShell').classList.toggle('menu-collapsed'); if ($('appShell').classList.contains('menu-collapsed')) closeTemplateSettings(); };
