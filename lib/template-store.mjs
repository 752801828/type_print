...
const pdfFont = async () => { for (const candidate of [process.env.FEIYE_PDF_FONT, '/usr/share/fonts/truetype/wqy/wqy-zenhei.ttf', '/usr/share/fonts/truetype/arphic/uming.ttf', '/usr/share/fonts/opentype/noto/NotoSansCJK-Regular.ttf', '/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf', 'C:\\Windows\\Fonts\\Deng.ttf', 'C:\\Windows\\Fonts\\simsunb.ttf', 'C:\\Windows\\Fonts\\SimsunExtG.ttf']) if (candidate && /\.(?:ttf|otf)$/i.test(candidate)) try { await fs.access(candidate); fontkit.openSync(candidate); return candidate; } catch {} return null; };
